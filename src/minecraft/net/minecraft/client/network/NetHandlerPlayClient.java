...
import me.lc.vodka.event.events.EventPlayerVelocity;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void addToSendQueue(Packet p_147297_1_) {
        new EventSendPacket(p_147297_1_).call();
    ...
    public void handleSoundEffect(S29PacketSoundEffect packetIn) {
        ...
        while (var3.hasNext()) {
            ...
            if (e instanceof EntityLivingBase) {
                ...
                double y = e.posY;
                double z = e.posZ;
                double distX = Math.abs( x - packetIn.getX() );
                double distY = Math.abs( y - packetIn.getY() );
                double distZ = Math.abs( z - packetIn.getZ() );
            }
        }
