...
public class GuiYesNo extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.field_175298_s.addAll(Fonts.clickgui.listFormattedStringToWidth(this.messageLine2, this.width - 50));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        Fonts.clickgui.drawString(this.messageLine1, this.width / 2 - 100, 70, 16777215);
        int i = 90;

        for (String s : this.field_175298_s)
        {
            Fonts.clickgui.drawString(s, this.width / 2 - 100, i, 16777215);
            i += Fonts.clickgui.FONT_HEIGHT;
        }
