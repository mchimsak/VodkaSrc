...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.mc.getTextureManager().bindTexture(new ResourceLocation("Vodka/background.jpg"));
        ...
        Fonts.clickgui.drawString(I18n.format("multiplayer.title", new Object[0]), this.width / 2, 20, 16777215);
