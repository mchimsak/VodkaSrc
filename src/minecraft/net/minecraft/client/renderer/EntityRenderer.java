...
import me.lc.vodka.module.impl.render.FovChanger;
...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    private float getFOVModifier(float partialTicks, boolean p_78481_2_) {
        if (this.debugView) {
            ...
            if (Vodka.INSTANCE.MODULE_MANAGER.getModule("FovChanger").isToggled()) {
                f = (float) FovChanger.value.getCurrentValue();
            }
            return f;
        }
    }
    ...
    private void hurtCameraEffect(float partialTicks) {
        if (!Vodka.INSTANCE.MODULE_MANAGER.getModule("NoHurtTime").isToggled()) {
    ...
    private void setupViewBobbing(float partialTicks) {
        if (!Vodka.INSTANCE.MODULE_MANAGER.getModule("NoBob").isToggled()) {
            if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
                ...
                GlStateManager.rotate(MathHelper.sin(f1 * 3.1415927F) * f2 * 10.0F, 0.0F, 0.0F, 1.0F);
