...
public class ItemRenderer
{
    ...
    private void func_178105_d(float p_178105_1_)
    {
        ...
        if (Vodka.INSTANCE.MODULE_MANAGER.getModule("HitAnimation").isToggled() && this.mc.thePlayer.isSwingInProgress) {
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        ...
        if(this.itemToRender != null) {
            ...
            } else if(abstractclientplayer.getItemInUseCount() <= 0 && !isBlocking) {
