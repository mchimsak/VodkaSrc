    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                if (Vodka.INSTANCE.MODULE_MANAGER.getModule("ESP").isToggled() && entity.getHealth() > 0.0 && entity instanceof EntityPlayer && !(entity instanceof EntityPlayerSP))
                {
                    GL11.glPushMatrix();
                    ...
                    GL11.glColor4d(0.0, 100, 200, 0.2);
