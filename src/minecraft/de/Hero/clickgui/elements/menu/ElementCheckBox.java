...
public class ElementCheckBox extends Element {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		 ...
		 */
		FontUtil.drawString(setstrg, (int)x + (int)width - FontUtil.getStringWidth(setstrg), (int)y + FontUtil.getFontHeight() / 2, 0xffffffff);
		Gui.drawRect((int)x + 1, (int)y + 2, (int)x + 12, (int)y + 13, set.getBooleanValue() ? color : 0xff000000);
	...
	public boolean mouseClicked(int mouseX, int mouseY, int mouseButton) {
		if (mouseButton == 0 && isCheckHovered(mouseX, mouseY)) {
			set.setBooleanValue(!set.getBooleanValue());
			return true;
		}
