...
public class CombatUtil
{
  ...
  public static float[] getRotationsNeededBlock(double x, double y, double z)
  {
    ...
    double diffY = y + 0.5D - (Minecraft.getMinecraft().thePlayer.posY + Minecraft.getMinecraft().thePlayer.getEyeHeight());
  ...
  {
    return Minecraft.getMinecraft().thePlayer.getDistance((box.minX + box.maxX) / 2.0D, (box.minY + box.maxY) / 2.0D, 
