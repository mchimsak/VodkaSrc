package me.lc.vodka.AltManager;
...
extends GuiScreen {
    ...
    public void drawScreen(int x2, int y2, float z2) {
        ...
        //Background
        RenderUtil.drawImage(new ResourceLocation("Vodka/background/background_"+this.background+".jpg"),0,0,s1.getScaledWidth(),s1.getScaledHeight());
